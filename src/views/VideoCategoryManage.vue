    ...
    <div class="admin-action-card">
      <div class="admin-action-card-inner">
        <div class="admin-page-title">
          <span class="admin-page-label">视频分类</span>
        </div>
        <div class="admin-action-group">
          ...
          <el-button @click="getCategoryList">
      ...
      >
        <el-table-column prop="name" label="分类名称" min-width="200">
          <template #default="{ row }">
            ...
            <el-tag v-if="row.level" size="small" type="info" effect="plain" class="level-tag">
              {{ row.level }}级
            </el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="videoCount" label="视频数" width="80" align="center">
          <template #default="{ row }">
            <el-tag type="info" effect="plain">{{ row.videoCount || 0 }}</el-tag>
          </template>
        </el-table-column>
          ...
          <template #default="{ row }">
            <div class="admin-action-links">
              ...
              <el-button
                ...
                :disabled="row.videoCount > 0 || (row.children && row.children.length > 0)"
              >
